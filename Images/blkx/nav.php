...
<div class="logo">
	<div class="leftpanel">
		<span class="featured_title">Featured Turorial</span>
		<span class="artistsName">Drake</span>
		<img src="/Images/blkx/artists/artist_64.png"></img>
	</div>
	<a href="index.php"><img src="/Images/sevenkeys.png"></img></a>	
	<div class="rightpanel">
		<iframe src="https://player.vimeo.com/video/75136872?autoplay=1" width="290" height="160" frameborder="1" webkitallowfullscreen mozallowfullscreen allowfullscreen autoplay="1">
