...
var Footer = (function () {
    function Footer(renderer, appRef) {
    ...
    Footer.prototype.resizeHandler = function () {
        var _this = this;
        if ($("history").length === 0)
            return;
        setTimeout(function () { return _this.getContentHeight(); }, 100);
    };
    Footer.prototype.getContentHeight = function () {
    ...
    Footer.prototype.isMobile = function () {
    ...
    Footer.prototype.over = function () {
        $('.map').find("img").attr("src", "/Images/maphover.png");
    };
    Footer.prototype.out = function () {
        $('.map').find("img").attr("src", "/Images/map.png");
    };
    Footer.prototype.ngAfterContentInit = function () {
        this.resizeHandler();
    };
    Footer = __decorate([
        core_1.Component({
